...
type Adobe = { version: any; flags0: number; flags1: number; transformCode: any; };
...
export class JPEGDecoder {
  ...
  private resetMaxMemoryUsage = function (maxMemoryUsageBytes_) {
  ...
  private requestMemoryAllocation(increaseAmount = 0) {
  ...
  private copyToImageData(imageData, formatAsRGBA) {
